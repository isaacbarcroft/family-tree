...
3. **1.6 Accessibility** — `TreeNode.tsx` keyboard support shipped 2026-05-10 (see 1.6 below); next up are modal focus traps, semantic `<main>`/`<nav>`/`<section>` page shells, and arrow-key tree navigation.
