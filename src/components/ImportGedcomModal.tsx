...
export default function ImportGedcomModal({ onClose, onImported }: ImportGedcomModalProps) {
  ...
  return (
    <Modal
      ...
      panelClassName="bg-gray-900 border border-gray-700 rounded-xl p-6 w-full max-w-lg max-h-[80vh] overflow-y-auto outline-none"
    >
      <div className="flex items-center justify-between mb-4">
        <h2 id={titleId} className="text-xl font-semibold text-white">Import GEDCOM</h2>
        {!importing && (
          <button
            onClick={onClose}
