...
--
-- Adds public.story_prompts, a curated question catalog for the home-page
-- prompt-of-the-day widget. Answering a prompt creates a normal memory row
-- with an optional memories.storyPromptId back-pointer, so prompts can be
-- reused across users and across days.
--
-- Rollback: 20260510_story_prompts_rollback.sql
